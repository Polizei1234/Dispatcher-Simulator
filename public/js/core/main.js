...
import '../systems/notification-system.js';
...
function cleanup() {
    ...
    if (window.RadioSystem) {
        window.RadioSystem.destroy();
    }

    if (window.RadioUI) {
        window.RadioUI.destroy();
    }
