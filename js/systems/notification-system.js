...
const NotificationSystem = {
    show: (...args) => notificationSystem.show(...args),
    info: (...args) => notificationSystem.info(...args),
    success: (...args) => notificationSystem.success(...args),
    warning: (...args) => notificationSystem.warning(...args),
    error: (...args) => notificationSystem.error(...args),
    dismiss: (...args) => notificationSystem.dismiss(...args),
